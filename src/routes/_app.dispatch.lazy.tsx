...
export const Route = createLazyFileRoute("/_app/dispatch")({
                      ...
                      <>
                        ...
                        >
                          <div className="font-medium">
                            ...
                            {isLate && (
                              <span title="出單後才確認（late addition）"><AlertTriangle className="ml-1 inline h-3.5 w-3.5 text-amber-500" /></span>
                            )}
                            {o.district && (
